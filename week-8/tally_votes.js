...
TALLY
  CREATE a function called tally with no arguments
  COUNT each time a given name is voted for a given position
  INSERT those tallies into voteCount

WINNER
  CREATE a function called winner with no arguments
  COMPARE each person's number of votes for each position
  INSERT the person with the highest number of votes into officers
...
What did you learn about iterating over nested objects in JavaScript?
  It's fairly easy and doable with basic for loops, and then for...in loops, and then for...in loops within for...in loops.
  Also, using a for...in loop, you can set the iterated variable to an object's properties.

Were you able to find useful methods to help you with this?
  mostly just the for...in loops - we didn't really need anything else.

What concepts were solidified in the process of working through this challenge?
  Iterating through objects, nested or otherwise.
  Properties.
  This.
  Nested loops.
